var ld;
        ...
        function loadGame(){
            ...
            var treeSrc = [_i("t1"),_i("t2"),_i("t3"),_i("t4"),_i("t5"),_i("t6"),_i("t7")];
            
            var trees = [];
            for(var n = 0; n < ((h*0.7)/50-2); n++){
                trees.push(new TreeBuilder(Math.floor(Math.random()*7),Math.floor(Math.random()*7),stp+n*50,1));
            }
            ...
            var carSrc = [_i("c3"),_i("c5"),_i("c6"),_i("c7"),_i("c8")];
            
            var cars = [];
            for(var n = 0; n < ((h*0.7+50)/gameDifficulty); n=n+2){
                cars.push(new CarBuilder(Math.floor(Math.random()*5),stp+n*gameDifficulty,4));
            }
            ...
            var coins = [];
            for(var n = 0; n < ((h*0.7+10)/(gameDifficulty-50)); n=n+8){
            ...
            function draw(){
                ...
                ctx.fill();
                ctx.closePath();
				ctx.drawImage(mark,720,220,40,500);
				
			    ctx.drawImage(str,210,550,150,150);
				
				ctx.drawImage(pedal,1200,600,200,140);
            ...
            function drawCar(){
                ...
                ctx.drawImage(car,cx,h-carH-40,170,110);
            }
